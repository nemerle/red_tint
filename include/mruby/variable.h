...
void mrb_vm_iv_set(mrb_state*, mrb_sym, const mrb_value &);
mrb_value mrb_vm_cv_get(mrb_state*, mrb_sym);
void mrb_vm_cv_set(mrb_state*, mrb_sym, mrb_value);
mrb_value mrb_vm_const_get(mrb_state*, mrb_sym);
void mrb_vm_const_set(mrb_state*, mrb_sym, mrb_value);
void mrb_const_set(mrb_state*, mrb_value, mrb_sym, mrb_value);
bool mrb_const_defined(mrb_state*, const mrb_value &, mrb_sym);
...
int mrb_const_defined_at(struct RClass *klass, mrb_sym id);
